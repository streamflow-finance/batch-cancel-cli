...
class CreateUncheckedArgs(typing.TypedDict):
    start_time: int
...
class CreateUncheckedAccounts(typing.TypedDict):
    sender: Pubkey
...
def create_unchecked(
    args: CreateUncheckedArgs,
    accounts: CreateUncheckedAccounts,
    ...
    identifier = b"\xae\xcd\xe3\x1e\x8c\xbaP\xc3"
